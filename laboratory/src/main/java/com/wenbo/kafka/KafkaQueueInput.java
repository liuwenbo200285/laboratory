 ...
 * 从Kafka里面读取数据
 */
public class KafkaQueueInput{
    private static final Logger LOGGER = LoggerFactory.getLogger(KafkaQueueInput.class);
    ...
    public static void main(String[] args){
    	KafkaQueueInput input = new KafkaQueueInput();
    	input.init();
    	input.doStart();
    }
    ...
    public void init() {
        //将析参数
        this.pZkConnect = "com.hunantv.stormnode2:2181,com.hunantv.stormnode1:2181,com.hunantv.stormnode5:2181,com.hunantv.stormnode4:2181,com.hunantv.stormnode3:2181";
        this.pTopic = "bid-3.1.3-default";
        this.pPartition = 4;
        this.pTimeout = 10000;
        this.pBorker = 6;
        this.pBulkSize = 10;
        this.pBokerList = "10.100.1.51:9092,10.100.1.52:9092,10.100.1.53:9092,10.100.1.54:9092,10.100.1.8:9092,10.100.1.9:9092";
        this.pGroupId = "otterror11";
    }
