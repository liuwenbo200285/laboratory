...
public class TestServerUtil {
	...
	public static void genaralKey(){
		try {
			...
			FileUtils.writeStringToFile(keyFile ,Base64Utils.encode(enc),"UTF-8");
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
	...
	public static void readKey(){
	    ...
	    try {
		     byte[] keyBytes = Base64Utils.decode(FileUtils.readFileToString(file,"UTF-8"));
...
//				object = ConnectionUtil.sendMsg("http://192.168.1.9:8081","sadfasdfsadf",object);
